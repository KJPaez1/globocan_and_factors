...
Estimation of EdI was based on the study of Lortet-Tieulent et al. (2020) (https://doi.org/10.1002/ijc.33114). 
For each country, the function below (calculate_EdI) takes as imput: - Expected Years of Scholarity (EYS) - Median Years of Scholarity (MYS) - Gross National Income per capita (GNI)
...
Mortality to incidence ratio vs EdI by tumor type
...
Mortality to incidence ratio vs HDI by tumor type
...
Mortality to incidence ratio vs SDI by tumor type
...
## Simple linear model grouped by cancer_type
