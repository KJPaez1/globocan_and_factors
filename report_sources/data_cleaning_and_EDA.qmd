...
```{r include=FALSE}
clean_data <- import(here("data", "hdi_and_composites_2022.csv"))
# Epidemiology
globocan_mortality <- import(here("data", "globocan_mortality.csv"))

globocan_incidence <- import(here("data", "globocan_incidence.csv"))

# Sociodemographic indicators
hdi_and_comp_2022 <- import(here("data", "hdi_and_composites_2022.csv"))
