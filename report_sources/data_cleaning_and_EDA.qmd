...
figure_3A_mir <- my_ggplot(figure_3A_data_mir) +
  ggplot2::labs(title = "Group A") +
  ggplot2::theme(axis.title = element_blank(),
                 legend.position = "none") +
  ggplot2::geom_point(
    aes(x = ed_i, y = asr_world),
    color = "black",
    fill = "black",
    size = 2.5,
    alpha = 0.6,
...
figure_3B_mir <- my_ggplot(figure_3B_data_mir) +
  ggplot2::labs(y = "Age-Standardized Rate (per 100,000)", title = "Group B") +
  ggplot2::theme(axis.title.y = element_text(hjust = 0), 
...
figure_3C_mir <- my_ggplot(figure_3C_data_mir) +
  ggplot2::labs(x = "Education and Income index (EdI)", title = "Group C") +
  ggplot2::theme(axis.title.y = element_blank(),
                 legend.position = "none") +
  ggplot2::geom_point(
...
# Arrange on one page
figure_3_mir <-
  figure_3A_mir + (figure_3B_mir + figure_3C_mir + plot_layout(ncol = 1)) +
  plot_layout(ncol = 1,
              guides = 'collect',
              axis_titles = 'collect') &
...
ggsave(
  plot = figure_3_mir,
  filename = here("outputs", "figure_3_mir.png"),
  width = 20,
  height = 15,
  dpi = 500,
  units = "in")
...
p_edi_inc = 
  ggboxplot(data_inc_edi_globocan_8, 
            ...
            scales = "free",
            xlab = "EdI category",
            ylab = "Age-standarized incidence rate (per 100,000 women)") 
...
p_edi_mort <- ggboxplot(data_mort_edi_globocan_8, 
               ...
               scales = "free",
               xlab = "EdI category",
               ylab = "Age-standarized mortality rate (per 100,000 women)"
               ) 
