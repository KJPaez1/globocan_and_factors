...
renderPlotly({
  plot_1 <- ggplot2::ggplot(
    data = filtered_data(),
    aes(x = .data[[input$variable_input]],
        color = Indicator,
        fill = Indicator)
    ) +
...
renderPlotly({
  plot_2 <- ggplot2::ggplot(
    data = filtered_data(),
    aes(y = .data[[input$variable_input]], 
        x = Indicator, 
        fill = Indicator, 
        color = Indicator)
    ) +
...
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    ...
    aes(x = .data[[input$variable_x_input_lm]],
...
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    ...
    aes(x = .data[[input$variable_x_input_lm_mir]],
        y = `ASR (World)`,
        color = `ASR (World)`)
    ) +
...
### Generalized Cross Validation (GCV) criterion for cubic regression spline

```{r}
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    data = selectedData_plot_gam(),
    aes(x = .data[[input$variable_x_input_gam]],
...
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    ...
    aes(x = .data[[input$variable_x_input_gam_mir]],
        y = `ASR (World)`,
        color = `ASR (World)`)
    ) +
    ggplot2::geom_point(size = 2, shape = 21) +
...
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    ...
    aes(x = .data[[input$variable_x_input_ns]],
...
renderPlotly({
  plot_3 <- ggplot2::ggplot(
    ...
    aes(x = .data[[input$variable_x_input_ns_mir]],
        y = `ASR (World)`,
        color = `ASR (World)`)
    ) +
    ggplot2::geom_point(size = 2, shape = 21) +
