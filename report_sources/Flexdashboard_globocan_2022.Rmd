...
blue_tones <- MetBrewer::met.brewer("Benedictus")[c(8, 9, 10, 11, 12)]

## Define a function to create the ANOVA tests for incidence
calculate_anova_incidence <- function(data, anova_data, indicator, asr, label_x, label_y, ...) {
  ggpubr::ggboxplot(
    data = data,
    x = indicator,
    y = asr,
...
red_tones <- MetBrewer::met.brewer("Benedictus")[c(5, 4, 3, 2, 1)]

## Define a function to create the ANOVA tests for mortality
calculate_anova_mortality <- function(data, anova_data, indicator, asr, label_x, label_y, ...) {
  ggpubr::ggboxplot(
    data = data,
    x = indicator,
    y = asr,
...
## Define a function to create the ANOVA tests for MIR
calculate_anova_mir <- function(data, anova_data, indicator, asr, label_x, label_y, ...) {
  ggpubr::ggboxplot(
    data = data,
    x = indicator,
    y = asr,
...
## One-Way ANOVA test of mortality by HDI category
...
## One-Way ANOVA test of mortality by SDI category
...
## One-Way ANOVA test of MIR by EdI category
figure_6a <- calculate_anova_mir(
...
## One-Way ANOVA test of MIR by HDI category
figure_6b <- calculate_anova_mir(
...
## One-Way ANOVA test of MIR by SDI category
figure_6c <- calculate_anova_mir(
