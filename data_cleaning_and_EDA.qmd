...
Human Development Index (hdi), hdi composites, and socio demographic (sdi) index
were retrieved from (Junior completalo !!!)

SDI and quintiles were retrieved from IHME-Global Health Exchange Data:
...
Venezuela (Boliarian Republic of) has been changed to Venezuela
France to France (metropolitan)
Democratic People's Republic of Korea has been changed to Korea, Democratic People Republic of
Iran (Islamic Republic of) to Iran, Islamic Republic of
Democratic Republic of the Congo to Congo, Democratic People Republic of
Gambia to The Republic of the Gambia
Netherlands to The Netherlands
Republic of Korea to Korea, Republic of
Cabo Verde to Cape Verde
Republic of Moldova to Moldova
Bosnia and Herzegovina to Bosnia Herzegovina
Bolivia (Plurinational State of) to Bolivia
United Republic of Tanzania to Tanzania, United Republic of
China (without Hong Kong and Macao) to China
...
Incidence vs sociodemographics development index by tumor type
...
p_incidence_v_sdi = 
  ...
  geom_point() +
  labs(y = "Age-standardized incidence rate",
       x = "Sociodemographic development index") +
  facet_wrap(~cancer_type, 
             scales = "free") +
  geom_smooth(method = "lm",
              se = F) +
...
Tamhane T2 test for variables with normal distribution but heterogeneous variances
------- for 

## Step 1: Select cancer types based visual inspection, normality test and
## R squared value

### Education and Income index (EDI) vs Incidence and Mortality
Visual inspection
...
Perform ANOVA, extract residuals, test normality and homogeneity of variances by
cancer type
...
Step 3: Re categorize if necessary



## Human Development Index (HDI) vs Incidence and Mortality
