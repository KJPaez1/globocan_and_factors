...
```{r}
palette_colors <- get_pal("plains_wanderer")
my_palette <- palette_colors[c(2:length(palette_colors), 1)]
```

```{r}
cancers_for_anova = globocan_5 |> 
  distinct(cancer_type, country_name, indicator, .keep_all = TRUE) |> 
  filter(cancer_type %in% c(" Brain, central nervous system", "Breast")) |>
...
```{r}
boxplot_bcns_inc_edi = 
  cancers_for_anova |> 
  filter(indicator == "incidence" & cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = edi_categories, col = edi_categories)) +
  labs(x = "", y = "Age-Standarized Incidence Rate (per 100,000)") +
...
boxplot_bcns_inc_hdi = 
  cancers_for_anova |>
  filter(indicator == "incidence", cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = hdi_category, col = hdi_category)) +
  labs(x = "", y = "") +
  geom_beeswarm(size = 6, alpha = 0.8) + 
  theme_classic(base_size = 23) +
  theme(legend.position = "none",
...
boxplot_bcns_inc_sdi = 
  cancers_for_anova |>
  filter(indicator == "incidence", cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = sdi_categories, col = sdi_categories)) +
  labs(x = "", y = "") +
  geom_beeswarm(size = 6, alpha = 0.8) + 
  theme_classic(base_size = 23) +
  theme(legend.position = "none",
...
boxplot_bcns_mort_edi = 
  cancers_for_anova |> 
  filter(indicator == "mortality", cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = edi_categories, col = edi_categories)) +
  labs(x = "Education and Income index", y = "Age-Standarized mortality Rate (per 100,000)") +
  geom_beeswarm(size = 6, alpha = 0.8) + 
  theme_classic(base_size = 23) +
  theme(legend.position = "none",
...
boxplot_bcns_mort_hdi = 
  cancers_for_anova |>
  filter(indicator == "mortality", cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = hdi_category, col = hdi_category)) +
  labs(x = "Human develepment index", y = "") +
  geom_beeswarm(size = 6, alpha = 0.8) + 
  theme_classic(base_size = 23) +
  theme(legend.position = "none",
        plot.margin = unit(c(1, 1, 0.7, 1), "cm"),
...
boxplot_bcns_mort_sdi = 
  cancers_for_anova |>
  filter(indicator == "mortality", cancer_type == " Brain, central nervous system") |> 
  ggplot(aes(y = asr_world, x = sdi_categories, col = sdi_categories)) +
  labs(x = "Sociodemographic index", y = "") +
  geom_beeswarm(size = 6, alpha = 0.8) + 
  theme_classic(base_size = 23) +
  theme(legend.position = "none",
        plot.margin = unit(c(1, 1, 0.7, 1), "cm"),
...
ggarrange(boxplot_bcns_inc_edi, boxplot_bcns_inc_hdi, boxplot_bcns_inc_sdi, 
...
ggarrange(boxplot_bc_edi, boxplot_bc_hdi, boxplot_bc_sdi, boxplot_bc_sdi, boxplot_bc_sdi)
```
